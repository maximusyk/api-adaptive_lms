...
import { CreateTokenDto, TokenEntityDto, UpdateTokenDto } from "./dto/tokens.dto";
...
export class TokensController {
  ...
  @Patch(":id")
  update(@Param() params: ParamsIdDto, @Body() updateTokenDto: UpdateTokenDto) {
    return this.tokensService.update(params?.id, updateTokenDto);
  }
